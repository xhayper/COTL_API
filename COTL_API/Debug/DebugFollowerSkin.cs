    ...
    public override List<WorshipperData.SlotsAndColours> Colors { get; } = new()
    {
        ...
        new WorshipperData.SlotsAndColours
        {
            SlotAndColours = new List<WorshipperData.SlotAndColor>
            {
                ...
                new WorshipperData.SlotAndColor("BODY_SKIN", new Color(0, 0, 1)),
                new WorshipperData.SlotAndColor("BODY_SKIN_BOWED", new Color(0, 0, 1)),
                new WorshipperData.SlotAndColor("BODY_SKIN_UP", new Color(0, 0, 1)),
                new WorshipperData.SlotAndColor("HEAD_SKIN_BTM", new Color(0, 0, 1)),
                new WorshipperData.SlotAndColor("HEAD_SKIN_TOP", new Color(0.5f, 0, 1))
            }
        }
    };
}